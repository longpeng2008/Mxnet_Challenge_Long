...
def __eval_result(submit_dict, ref_dict, error_list):
    # eval accuracy
    ...
    for (key, value) in ref_dict.items():
        ...
        if value in submit_dict[key][:3]:
            ...
            error_list.write(str(value))
            error_list.write('/')
            error_list.write(str(key))
            error_list.write('\n')
